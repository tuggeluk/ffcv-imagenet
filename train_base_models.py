...
configs_dict["--data.dataset"] = 'ImageNet'
configs_dict["--logging.wandb_dryrun"] = 0
configs_dict["--logging.wandb_project"] = "train_base_models_VIT"
...
configs_dict["--model.pretrained"] = [0]
configs_dict["--model.arch"] = ['vit_b_32']
